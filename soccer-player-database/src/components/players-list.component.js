...
const Player = (props) => (
  <tr>
    ...
    <td className="d-none d-sm-table-cell" className="text-center">
      {props.player.matches.length}
    </td>
    <td>
...
export default class PlayersList extends Component {
  ...
  //get request for all players, that sets array in state to the returned players 
  componentDidMount() {
    axios
